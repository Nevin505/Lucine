  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center px-4 py-8">
      ...
      <div
        ...
        className="relative z-10 w-full max-w-[440px] rounded-[18px] border border-white/35 bg-[#e8f2f0] p-7 shadow-[0_24px_60px_rgba(8,20,24,0.4)] animate-[rise_280ms_ease_both]"
      >
        {children}
      </div>
    </div>
